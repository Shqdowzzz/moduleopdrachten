...
<p>Gender</p>
    ...
    <input type="radio" id="help" name="gender" value="vrouwelijk">
...
if(isset($_POST['soort']) && isset($_POST['ras']) && isset($_POST['naam']) && isset($_POST['gender']) && isset($_POST['leeftijd']))
{
...
$soort = mysqli_real_escape_string($con, $_POST['soort']);
